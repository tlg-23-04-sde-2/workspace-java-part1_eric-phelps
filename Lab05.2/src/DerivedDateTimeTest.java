...
class DerivedDateTimeTest
{
    ...
    public static void testPopularBirthdays()
    {
        ...
        LocalDate conceptionDay = LocalDate.of(2023, 04, 14);
        LocalDate birth = conceptionDay.plusWeeks(38);
        System.out.println(birth);

        // TODO: what is the average birthday of someone conceived on New Year's Eve (after midnight)?;
        LocalDate conception = LocalDate.of(2023, 01, 01);
        LocalDate bday = conception.plusWeeks(38);
    ...
    {
        // TODO;
        LocalDate myBirth = LocalDate.of(1994, 05, 24);
    ...
    {
        // TODO;
        LocalDate septStart94 = LocalDate.of(1994, 9, 01);
        LocalDate laborDay94 = septStart94.with(firstInMonth(MONDAY));
        System.out.println(laborDay94);
    ...
    {
        // utilizes static imports to simplify the temporal adjustments and the DayOfWeek.
        LocalDate nov1 = LocalDate.of(2024, 11, 1);
        LocalDate electionDay24 = nov1.with(TemporalAdjusters.firstInMonth(MONDAY)).plusDays(1);
        System.out.println(electionDay24);
        System.out.println(electionDay24.getDayOfWeek());
    }
    ...
    public static void testAnniversary()
    {
        ...
        LocalDate anni50 = wedding.plusYears(50);
        System.out.println(anni50.getDayOfWeek());
        LocalDate party = anni50.with(nextOrSame(SATURDAY));
