...
public class Television {
    ...
    //Television HAS-A Tuner, this is still considered a property
    ...
    public void turnOff()
    {
        ...
        //tuner methods, but still business methods for the television to use.
...
//                    "Valid range is [" + MIN_VOLUME + "-" + MAX_VOLUME + "].");
            System.out.printf("Invalid volume: %s. Valid range is %s to %s.", volume, MIN_VOLUME, MAX_VOLUME);
        }
    }
    ...
    public String toString()
    {
     /*   return "com.entertainment.Television" +
                ...
                ", display=" + getDisplay();
     */
        return String.format("com.entertainment.Television brand= %s, volume= %s, display= %s, currentChannel= %s"
